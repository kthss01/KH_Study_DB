...
-- 단순 메세지를 출력하는 트리거 작성 (문장 트리거)
-- 사원 테이블에 새로운 데이터가 들어오면 신입사원이 입사하였습니다를 출력
...
VALUES
    (300, '유야호', '650512-1151432', 'gil@kh.or.kr', '01012345567', 'D5', 'J3', 'S5', 3000000, 0.1, 200, SYSDATE, NULL, DEFAULT);
    
-- 제품이 입고될때마다 상품재고 테이블의 수치를 관리자가 수동으로 관리하면 불편,
-- 이때 트리거를 이용하면 재고가 입출고시 자동으로 입력되도록 할 수 있다.
